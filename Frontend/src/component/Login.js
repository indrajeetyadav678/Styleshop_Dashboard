        ...
        <section id="Acc_mainbox">
          ...
          <div id="Acc_createbox" className="acc_createbox">
            ...
            <div id="Rtwo">
              ...
              />
              <TiTick id="Rtwocorect" />
              <VscError id="Rtwoerror" />
            </div>
            <div id="errormsgbox">
            ...
            <div id="Rthree">
              ...
              <input
                ...
                onChange={inputhandle}
              />
              <TiTick id="Rthreecorect" />
              <VscError id="Rthreeerror" />
            </div>
            <div id="errormsgbox">
              <h6 id="Rthreeerrormsg">
                password must have number Letter and spcial charector
              </h6>
            </div>
            <div id="login_rem_box">
              <label for="remember">Forget password</label>
              <button onClick={signup} className="sign1">
                Sign up
              </button>
            </div>
            <br />
